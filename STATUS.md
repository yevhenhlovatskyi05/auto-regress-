...
Автоматично оновлюється workflow'ом `.github/workflows/rc-regression-autotrigger.yml` після кожного запуску.

| Дата | Час (UTC) | Час (Kyiv) | Команду знайдено | Текст повідомлення |
|---|---|---|---|---|
| 2026-07-30 | 09:25:31 | 12:25:31 | true | @Eugene Glovatskiy please start regress to RC |
| 2026-08-04 | 20:38:54 | 23:38:54 | false | |

<div align="right">

<!--
  Поки автотестів немає — кнопка неактивна (просто картинка, не посилання).
